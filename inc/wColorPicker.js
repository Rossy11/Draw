...
{	
	...
	ColorPicker.prototype =
	{
		generate: function ()
		{
			...
			//var simpleColors = ['000000', '333333', '666666', '999999', 'CCCCCC', 'FFFFFF', 'FF0000', '00FF00', '0000FF', 'FFFF00', '00FFFF', 'FF00FF']; todo...
			var simpleColors = [];
			...
			// var mixedColors =
			// 	[
			// 	'7ed321', '57ffff', 'ff5e6c', 'fcfdba', 'FFFFFF', '7ed321', '330000', '333300', '336600', '339900', '33CC00', '33FF00', '660000', '663300', '666600', '669900', '66CC00', '66FF00',
			...
			// ];
            var mixedColors = [
                '7ed321', '57ffff', 'ff5e6c', 'fcfdba', 'FFFFFF', '7ed321'
            ]; //todo...
		...
		appendColors: function($palette, colors, lineCount)
		{
			...
			for(index in colors)
			{
				$palette.append(
					...
					.click(function(){
						//todo...
						var thisRgb=$(this).css('backgroundColor');
                        setActive(thisRgb)
						//todo end
		...
		appendToElement: function($element)
		{
			...
			{
				//setup button
				$this.paletteHolder = $('<div class="_wColorPicker_paletteHolder"></div>').css({width: 60}).append($this.colorPicker);
				...
				// $this.paletteHolder.css({width: $this.width, height: $this.height}).hide(); todo
				...
				{
					// $(document).click(function(){if($this.paletteHolder.hasClass('active'))$this.hidePalette($this);}); todo
		...
		hidePalette: function($this)
		{
			...
			if($this.paletteHolder.hasClass('active'))
			{
				...
				if($this.settings.effect == 'slide')
				{
					// $this.paletteHolder.stop(true, false).animate({height: 0, top: ($this.slideTopToBottom == 0 ? 0 : $this.slideTopToBottom)}, $this.settings.hideSpeed, function(){$this.paletteHolder.hide()}); todo
				}
				else if($this.settings.effect == 'fade')
				{
					// $this.paletteHolder.stop(true, false).animate({opacity: 0}, $this.settings.hideSpeed, function(){$this.paletteHolder.hide()}); todo
				}
				else
				{
					// $this.paletteHolder.hide(); todo
				}
			}
		},
